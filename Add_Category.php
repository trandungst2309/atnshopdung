				 ...
				 <div class="form-group">
					...
					<div class="form-group">
						<div class="col-sm-offset-2 col-sm-10">
						      <input type="submit"  class="btn btn-primary" style="background-color:black;color:white" name="btnAdd" id="btnAdd" value="Add new"/>
                              <input type="button" class="btn btn-primary" style="background-color:black;color:white" name="btnIgnore"  id="btnIgnore" value="Ignore" onclick="window.location='?page=category_management'" />
